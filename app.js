...
client.on('message', message => 
{
		...
		if(cmd == "battle" || cmd == "baltop" || cmd == "bal" || cmd == "balance" || cmd == "balancetop" || cmd == "burger" || cmd == "coinflip" || cmd == "daily" || cmd == "pay" || cmd == "profile" || cmd == "rate" || cmd == "store" || cmd == "use" || cmd == "horserace") return post("Fuck you Bunny. :p");

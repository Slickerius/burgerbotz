...
client.on('message', message => 
{
		...
		switch(cmd)
		{
			...
			if(args[1] == parseInt(args[1]) && args[2] == parseInt(args[2]) && args[3] == parseInt(args[3]))
			{
				...
				ch.send({files: ['https://cdn.discordapp.com/attachments/563998568940306437/573785938443108352/unknown.png']} + "Find roots, factors for quadratic equations using Burgerbotz quadratic equation solver!\nUsage: /q <a> <b> <c>");
				break;
